...
COLLECTION_NAME = "trivia_private"
    ...
    "$and": [
        ...
        #validates types, enums, the ALWAYS required fields, and nested structures
        {
            "$jsonSchema": {
                ...
                "required": ["_id", "is_edit", "question", "answer", "language"], #ADD THE OG ID FIELD 
                "properties": {
...
#         db.command('collMod', COLLECTION_NAME, **{'validator': trivia_private_schema, 'validationLevel': 'strict'})
...
#             COLLECTION_NAME, 
#             validator=trivia_private_schema, #****change this line to say collection_privateOrPublic_schema
