...
COLLECTION_NAME = "quotes_private"
...
try:
    ...
    if COLLECTION_NAME in db.list_collection_names(): #this should not be the case but just to be safe
        ...
        db.command('collMod', COLLECTION_NAME, **{'validator': quotes_private_schema, 'validationLevel': 'strict'})
        ...
        db.create_collection(
            COLLECTION_NAME, 
            validator=quotes_private_schema, #****change this line to say collection_privateOrPublic_schema
