...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..nBUJLYjEIpsW96O6adrFZD6IivAPfU3NU6TsgvWQoZE' //PUT TOKEN HERE!
