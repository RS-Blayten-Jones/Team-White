...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..u-D03K1eXId1HG130aNjYsbVGYEyyQYz-H3j6QEzNjY' //PUT TOKEN HERE!
