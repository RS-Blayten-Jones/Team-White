...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..UAKBUkZKp4Xrn6_HLgNQTTSI0IJaNkcPaUdJ1GfvQD8' //PUT TOKEN HERE!
