...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..vV7S-Xk54E09Iu_mT53U1xWGh-64zR4SjwYY6zmxfiI' //PUT TOKEN HERE!
