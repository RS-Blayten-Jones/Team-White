...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..4OJzJYHEJDdLd-Eq3MX6VbLi1sRJQaOsEq_BbiCaKik' //PUT TOKEN HERE!
