...
async function handleLogin(credentials: { username: string; password: string }) {
  ...
  try {
    ...
    const hardcodedJwt = 'eyJhbGciOiJIUzI1NiJ9..nNR9Eig1seihZawsGdJk1iNcLKhatPr-flhv2F5p7Jk' //PUT TOKEN HERE!
